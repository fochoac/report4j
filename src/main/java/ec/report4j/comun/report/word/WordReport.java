 ...
 *          16/04/2019
 *
 *          La clase {@link WordReport} sirve para generar reportes de word con tablas.
 */
public class WordReport extends Report {
    ...
    public WordReport assignTemplate(InputStream plantilla, Map<String, Object> parametros, List<TableWord> tablas) throws ReportException {
    	assignTemplate(plantilla, parametros);
        this.tablas = tablas;
        return this;
    }

    public WordReport assignTemplate(File plantilla, Map<String, Object> parametros, List<TableWord> tablas) throws ReportException {
    	assignTemplate(plantilla, parametros);
        this.tablas = tablas;
        return this;
    }
